...
export function ProductCard({ id, name, price, image, rating, reviews, badge, index = 0 }: ProductCardProps) {
  ...
  return (
    ...
    >
      <div className="relative h-full rounded-2xl overflow-hidden group bg-slate-900/50 border border-slate-700/50 backdrop-blur-sm">
        ...
        <div className="relative aspect-square overflow-hidden bg-slate-800">
          {badge && (
            <motion.div
              className="absolute top-4 right-4 z-20 px-4 py-2 rounded-lg font-bold text-sm bg-gradient-to-r from-magenta-600 to-cyan-600 text-white"
          ...
          <motion.div
            ...
            animate={
              isHovered
                ? {
                    borderColor: ["rgba(217, 70, 239, 0.3)", "rgba(6, 182, 212, 0.5)", "rgba(217, 70, 239, 0.3)"],
                    boxShadow: [
          ...
          >
            <Button
              size="lg"
              className="bg-gradient-to-r from-magenta-600 to-cyan-600 hover:from-magenta-500 hover:to-cyan-500 text-white font-bold px-8 rounded-lg shadow-lg"
        ...
        <div className="p-6 flex flex-col justify-between h-full">
          <motion.h3
            ...
            whileHover={{
              textShadow: isHovered ? "2px 2px #d946ef, -2px -2px #06b6d4" : "none",
            }}
          >
            {name}
          </motion.h3>
          ...
          <div className="flex items-center justify-between mt-auto">
            <motion.div
              className="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-magenta-400 to-cyan-400"
            ...
            <motion.button
              className="p-3 rounded-full bg-gradient-to-r from-magenta-600/20 to-cyan-600/20 border border-magenta-500/30 hover:border-magenta-500/60 text-white transition-all"
              whileHover={{
                scale: 1.15,
